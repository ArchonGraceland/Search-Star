      ...
      <main>
        ...
        <section className="py-20 px-6" style={{ background: '#eef2f8' }}>
          <div className="max-w-2xl mx-auto">
            ...
            <p style={{ fontSize: '17px', color: '#3a3a3a', lineHeight: 1.8, marginBottom: '22px' }}>
              Trust, in the Search Star model, is not a feeling. It is not a vibe or an impression or a gut read. It is an act. When a sponsor pledges money against a commitment, they are performing an act of trust — putting skin in the game on their belief in the practitioner. When they stay present through the full 90 days and release the pledge at day 90, they are performing another act of trust — affirming, with real stakes, that the work was real. When they veto, they are performing an act too: withdrawing belief when it breaks. Every one of these is costly.
            </p>
            <p style={{ fontSize: '17px', color: '#3a3a3a', lineHeight: 1.8, marginBottom: '22px' }}>
              This is vouching with stakes. The sponsor who pledges has put money on the line. The sponsor who stays through 90 days has kept it there despite the ability to withdraw at any moment. These are not costless gestures. They are commitments. And the accumulation of those commitments, over time, is what a Trust record actually is: a ledger of people who were willing to stake something on their belief in you.
            </p>
            <p style={{ fontSize: '17px', color: '#3a3a3a', lineHeight: 1.8 }}>
              The convergence principle, which is the philosophical core of the whole system, is this: because the Trust record can only be built through actual behavior backed by people with stakes, the only reliable strategy for building a good Trust record is to actually be the kind of person it describes. You cannot optimize your way into a Mature Trust stage. You can only practice your way there. Which means that as the system grows, the people at the highest trust stages will, reliably, be the people who have done the most actual work over the most actual time, backed by the most actual sponsors who stayed.
            </p>
          </div>
        </section>
