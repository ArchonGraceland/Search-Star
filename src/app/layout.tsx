...
export const metadata: Metadata = {
  title: "Search Star — Own Your Data, Set Your Price",
  description: "Sovereign personal data standard. You host your own data, platforms query your API, and you get paid per query.",
  icons: {
